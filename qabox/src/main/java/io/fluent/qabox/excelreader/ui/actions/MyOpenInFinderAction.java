...
public class MyOpenInFinderAction extends DumbAwareAction {

    public String filePath;

    public MyOpenInFinderAction() {
        super(() -> ComponentBundle.message("home.toolbar.open.in.finder"), AllIcons.Actions.MenuOpen);
    }
