package io.fluent.springboot.tpl;
...
public class TestSpringbootTplApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(SpringbootTplApplication::main).with(TestSpringbootTplApplication.class).run(args);
    }
