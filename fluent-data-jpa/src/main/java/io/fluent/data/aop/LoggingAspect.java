...
public class LoggingAspect {
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "within(io.fluent.data.*)", returning = "result")
	...
	@AfterThrowing(pointcut = "within(io.fluent.data.*)", throwing = "error")
